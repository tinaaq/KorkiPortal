...
import tutorStudentsRoutes from './modules/tutors/tutorStudents.routes.js';
import studentsRoutes from './modules/students/students.routes.js';
import studentTutorsRoutes from './modules/students/studentTutors.routes.js';
...
app.use('/api/tutor',tutorStudentsRoutes);
app.use('/api/tutors/subjects', tutorSubjectsRoutes);
app.use('/api/tutors', tutorsRoutes);

app.use('/api/students', studentsRoutes);
//lista tutors dla student
app.use('/api/student', studentTutorsRoutes);
